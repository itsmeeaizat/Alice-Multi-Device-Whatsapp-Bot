...
module.exports = {
  ...
  operate: async (context) => {
    ...
    try {
      ...
      await Alice.sendMessage(m.chat, { image: { url: imageUrl }, caption: `Fire Text: ${text}` }, { quoted: m });
    } catch (e) {
