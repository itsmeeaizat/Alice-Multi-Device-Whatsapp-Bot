...
module.exports = {
  ...
  operate: async (context) => {
    ...
    try {
      ...
      await Alice.sendMessage(m.chat, { image: { url: imageUrl }, caption: `Neon Logo: ${text}` }, { quoted: m });
    } catch (e) {
