...
module.exports = {
  ...
  operate: async (context) => {
    ...
    const apiUrl = `https://fastrestapis.fasturl.cloud/ephoto/glitchtext?text=${encodeURIComponent(text)}`;
    ...
    try {
      ...
      await Alice.sendMessage(m.chat, { image: { url: imageUrl }, caption: `Glitch Text: ${text}` }, { quoted: m });
    } catch (e) {
